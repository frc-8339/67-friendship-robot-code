...
import frc.penrobo.commands.DropIntake;
...
import frc.penrobo.commands.RetractIntake;
...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // new Trigger(() ->
        // joystick.getRawButton(3)).whileTrue(swerveSubsystem.driveForward());
        // new Trigger(() -> joystick.getRawButton(4))
        // .whileTrue(new RunCommand(() -> swerveSubsystem.drive(new Translation2d(-1,
        // 0), 0, false), swerveSubsystem));
        // new Trigger(() -> joystick.getRawButton(5))
        // .whileTrue(new RunCommand(() -> swerveSubsystem.drive(new Translation2d(0,
        // 1), 0, false), swerveSubsystem));
